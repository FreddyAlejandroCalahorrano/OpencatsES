...
class CompaniesUI extends UserInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Empresas';
        $this->_subTabs = array(
            'Agregar Empresa'     => CATSUtility::getIndexName() . '?m=companies&amp;a=add*al=' . ACCESS_LEVEL_EDIT . '@companies.add' . '*hrmode=0',
            'Buscar Empresas' => CATSUtility::getIndexName() . '?m=companies&amp;a=search*hrmode=0',
            'Ir a mi Empresa' => CATSUtility::getIndexName() . '?m=companies&amp;a=internalPostings*hrmode=0'
        );
    }

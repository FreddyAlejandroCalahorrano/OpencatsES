...
class CompaniesListByViewDataGrid extends CompaniesDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItemPopup('Agregar a Lista', CATSUtility::getIndexName().'?m=lists&amp;a=addToListFromDatagridModal&amp;dataItemType='.DATA_ITEM_COMPANY, 450, 350);
...
class companiesSavedListByViewDataGrid extends CompaniesDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItem('Eliminar de esta Lista', CATSUtility::getIndexName().'?m=lists&amp;a=removeFromListDatagrid&amp;dataItemType='.DATA_ITEM_COMPANY.'&amp;savedListID='.$this->getMiscArgument(), false);
        $html .= $this->getInnerActionAreaItem('Exportar', CATSUtility::getIndexName().'?m=export&amp;a=exportByDataGrid');

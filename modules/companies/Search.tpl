        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Empresas: Búscar Empresas</h2></td>
                </tr>
            </table>

            <p class="note">Búscar Empresas</p>
                    ...
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            ...
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByName"<?php if ($this->mode == "searchByName"): ?> selected<?php endif; ?>>Nombre</option>
                                <option value="searchByKeyTechnologies"<?php if ($this->mode == "searchByKeyTechnologies"): ?> selected<?php endif; ?>>Tecnologías Clave</option>
                            </select>&nbsp;
                            ...
                            <input type="submit" class="button" id="searchCompanies" name="searchCompanies" value="Buscar" />
            ...
            <?php if ($this->isResultsMode): ?>
                <br />
                <p class="note">Resultados de la Busqueda (<?php echo(count($this->rs)); ?>)</p>
                    ...
                    <table class="sortable" width="100%" onmouseover="javascript:trackTableHighlight(event)">
                        <tr>
                            ...
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('name', 'Nombre'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('phone1', 'Teléfono Principal'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">Tecnologías Clave</th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('city', 'Creado'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                        ...
                        <?php foreach ($this->rs as $rowNumber => $data): ?>
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    ...
                                    <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=show&amp;companyID=<?php $this->_($data['companyID']); ?>')" title="Ver en una Nueva Ventana">

        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Órdenes de trabajo: Buscar Órdenes de Trabajo</h2></td>
                </tr>
            </table>

            <p class="note">Buscar Órdenes de Trabajo</p>
                ...
                <tr>
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            ...
                            <label id="searchModeLabel" for="searchMode">Búscar por:</label>&nbsp;
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByJobTitle"<?php if ($this->mode == "searchByJobTitle"): ?> selected="selected"<?php endif; ?>>Título Profesional</option>
                                <option value="searchByCompanyName"<?php if ($this->mode == "searchByCompanyName"): ?> selected="selected"<?php endif; ?>>Nombre de Empresa</option>
                            </select>&nbsp;
                            ...
                            <input type="submit" class="button" id="searchJobOrders" name="searchJobOrders" value="Buscar" />
            ...
            <?php if ($this->isResultsMode): ?>
                <br />
                <p class="note">Resultados de la Búsqueda</p>
                    ...
                    <table class="sortable" width="100%" onmouseover="javascript:trackTableHighlight(event)">
                        <tr>
                            ...
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('title', 'Título'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('companyName', 'Empresa'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('type', 'Tipo'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('status', 'Estado'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('dateCreated', 'Creado'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('startDate', 'Inicio'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('recruiterLastName', 'Reclutador'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('owner_user.last_name', 'Dueño'); ?>
                            </th>
                        </tr>
                            ...
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    <input type="checkbox" id="checked_<?php echo($data['jobOrderID']); ?>" name="checked_<?php echo($data['jobOrderID']); ?>" />
                                     <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=show&amp;jobOrderID=<?php $this->_($data['jobOrderID']); ?>')" title="Ver en una Ventana Nueva">

        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Órdenes de Tabajo: Editar Orden de Trabajo</h2></td>
                </tr>
            </table>

            <p class="note">Editar Orden de Trabajo</p>
            ...
            <form name="editJobOrderForm" id="editJobOrderForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editJobOrderForm);" autocomplete="off">
                ...
                <table class="editTable" width="700">
                    <tr>
                        <td class="tdVertical">
                            <label id="titleLabel" for="title">Titulo:</label>
                        </td>
                        <td class="tdData">
                        ...
                        <td class="tdData">
                            <select tabindex="15" id="type" name="type" class="inputbox" style="width: 150px;">
                                ...
                                <?php if(count($this->jobTypes) < 1): ?>
                                    <option value="N/A" selected>N/A (No Aplicable)</option>
                                <?php endif; ?>
                            </select>&nbsp;*
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdVertical">
                            <label id="openingsLabel" for="openings">Vacantes Totales:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        ...
                        <td class="tdVertical">
                            <label id="openingsAvailableLabel" for="openingsAvailable">Vacantes Restantes:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        ...
                        <td class="tdVertical">
                            <label id="companyJobIDLabel" for="openings">ID de Trabajo de la Empresa:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="statusLabel" for="status">Estado:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr id="displayQuestionnaires" style="<?php if ($this->isPublic): ?>display: table-row;<?php else: ?>display: none;<?php endif; ?>">
                        ...
                        <td class="tdData">
                            ...
                            <?php foreach ($this->questionnaires as $questionnaire): ?>
                                <option value="<?php echo $questionnaire['questionnaireID']; ?>"<?php if ($this->questionnaireID == $questionnaire['questionnaireID']) echo 'seleccionado'; ?>><?php echo $questionnaire['title']; ?></option>
                            <?php endforeach; ?>
                            </select>
                ...
                <input type="submit" tabindex="22" class="button" name="submit" id="submit" value="Guardar" />&nbsp;
                <input type="reset"  tabindex="23" class="button" name="reset"  id="reset"  value="Borrar" />&nbsp;
                <input type="button" tabindex="24" class="button" name="back"   id="back"   value="Volver a Detalles" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=show&amp;jobOrderID=<?php echo($this->jobOrderID); ?>');" />
            </form>

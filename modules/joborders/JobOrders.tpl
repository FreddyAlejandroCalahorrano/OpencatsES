        ...
        <div id="contents"<?php echo !$this->totalJobOrders ? ' style="background-color: #E6EEFF; padding: 0;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td><h2>Órdenes de Trabajo: Inicio</h2></td>
                                ...
                                <tr>
                                    <td>
                                        <select name="view" id="view" onchange="<?php echo($this->dataGrid->getJSAddFilter('Status', '==', 'this.value', 'true')); ?>" class="selectBox">
                                            ...
                                            ?>
                                            <option value=""<?php if ($this->dataGrid->getFilterValue('Status') == ''): ?> selected="selected"<?php endif; ?>>Todo</option>
                                        </select>
                                    </td>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyJobOrders">Solo mis Órdenes de Trabajo</label>&nbsp;
            ...
            <?php if ($this->totalJobOrders): ?>
            <p class="note">
                <span style="float:left;">Órdenes de Trabajo  -

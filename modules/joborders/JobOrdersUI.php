...
class JobOrdersUI extends UserInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Órd. Trabajo';
        $this->_subTabs = array(
            //'Add Job Order'     => CATSUtility::getIndexName() . '?m=joborders&amp;a=add*al=' . ACCESS_LEVEL_EDIT . '@joborders.add',
            'Añadir Orden de Trabajo' => 'javascript:void(0);*js=showPopWin(\''.CATSUtility::getIndexName().'?m=joborders&amp;a=addJobOrderPopup\', 400, 250, null);*al=' . ACCESS_LEVEL_EDIT . '@joborders.add',
            'Buscar Orden de Trabajo' => CATSUtility::getIndexName() . '?m=joborders&amp;a=search'
        );
    }

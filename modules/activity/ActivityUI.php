...
class ActivityUI extends UserInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Actividades';
    }
    ...
    private function getQuickLinks()
    {
        ...
        $quickLinks[0] = sprintf(
            '<a href="%s&amp;startMonth=%s&amp;startDay=%s&amp;startYear=%s&amp;endMonth=%s&amp;endDay=%s&amp;endYear=%s">Hoy</a>',
            $baseURL,
            $today['month'],
            $today['day'],
            $today['year'],
        ...
        $quickLinks[1] = sprintf(
            '<a href="%s&amp;startMonth=%s&amp;startDay=%s&amp;startYear=%s&amp;endMonth=%s&amp;endDay=%s&amp;endYear=%s">Ayer</a>',
            $baseURL,
            $yesterday['month'],
            $yesterday['day'],
            $yesterday['year'],
        ...
        $quickLinks[2] = sprintf(
            '<a href="%s&amp;period=lastweek">La Semana Pasada</a>',
            $baseURL
        );

        $quickLinks[3] = sprintf(
            '<a href="%s&amp;period=lastmonth">El Mes Pasado</a>',
            $baseURL
        );

        $quickLinks[4] = sprintf(
            '<a href="%s&amp;period=lastsixmonths">Los Últimos 6 Meses</a>',
            $baseURL
        );

        $quickLinks[5] = sprintf(
            '<a href="%s&amp;period=all">Todo</a>',
            $baseURL
        );

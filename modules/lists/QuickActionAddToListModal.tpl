...
<?php TemplateUtility::printModalHeader('Candidates', array('js/lists.js'), 'Agregar a Lista Estática de '.$this->dataItemDesc); ?>
    <table>
        <tr>
            <td><!--Add to Static Lists-->Seleccione las listas a las que desea agregar el artículo <?php if (count($this->dataItemIDArray) > 1): ?>s<?php endif; ?> a.</td>
       </tr>
    </table>
            <div class="addToListListBox" id="addToListBox">
                ...
                <?php foreach($this->savedListsRS as $index => $data): ?>
                    <div class="<?php TemplateUtility::printAlternatingDivClass($index); ?>" id="savedListRow<?php echo($data['savedListID']); ?>">
                        ...
                        <span style="float:right; padding-right:25px;">
                            <a href="javascript:void(0);" onclick="editListRow(<?php echo($data['savedListID']); ?>);" style="text-decoration:none;"><img src="images/actions/edit.gif" border="0">&nbsp;Editar</a>
                        </span>
                    </div>
                    <div class="<?php TemplateUtility::printAlternatingDivClass($index); ?>" style="display:none;" id="savedListRowEditing<?php echo($data['savedListID']); ?>">
                        ...
                        <span style="float:right; padding-right:25px;">
                            <a href="javascript:void(0);" onclick="deleteListRow(<?php echo($data['savedListID']); ?>, '<?php echo($this->sessionCookie); ?>', <?php echo($data['numberEntries']); ?>);" style="text-decoration:none;"><img src="images/actions/delete.gif" border="0">&nbsp;Borrar</a>&nbsp;
                            <a href="javascript:void(0);" onclick="saveListRow(<?php echo($data['savedListID']); ?>, '<?php echo($this->sessionCookie); ?>');" style="text-decoration:none;"><img src="images/actions/screen.gif" border="0">&nbsp;Guardar</a>
                        </span>
                    </div>
                    <div class="<?php TemplateUtility::printAlternatingDivClass($index); ?>" style="display:none;" id="savedListRowAjaxing<?php echo($data['savedListID']); ?>">
                        <img src="images/indicator.gif">&nbsp;Guardando Cambios, Espere ...
                    </div>
                <?php endforeach; ?>
                <div class="<?php TemplateUtility::printAlternatingDivClass(count($this->savedListsRS)); ?>" style="display:none;" id="savedListNew">
                    ...
                    <span style="float:right; padding-right:25px;">
                        <a href="javascript:void(0);" onclick="document.getElementById('savedListNew').style.display='none';" style="text-decoration:none;"><img src="images/actions/delete.gif" border="0">&nbsp;Borrar</a>&nbsp;
                        <a href="javascript:void(0);" onclick="commitNewList('<?php echo($this->sessionCookie); ?>', <?php echo($this->dataItemType); ?>);" style="text-decoration:none;"><img src="images/actions/screen.gif" border="0">&nbsp;Guardar</a>
                    </span>
                </div>
                <div class="<?php TemplateUtility::printAlternatingDivClass(count($this->savedListsRS)); ?>" style="display:none;" id="savedListNewAjaxing">
                    <img src="images/indicator.gif">&nbsp;Guardando Cambios...
                </div>
            </div>
            <br />
            <div style="float:right;" id="actionArea">
                <input type="button" class="button" value="Nueva Lista" onclick="addListRow();">&nbsp;
                <input type="button" class="button" value="Agregar a Listas" onclick="addItemsToList('<?php echo($this->sessionCookie); ?>', <?php echo($this->dataItemType); ?>);">&nbsp;
                <input type="button" class="button" value="Cancelar" onclick="parentHidePopWin();">&nbsp;
            </div>
            <div style="display:none; font: normal normal normal 12px/130% Arial, Tahoma, sans-serif;" id="addingToListAjaxing">
                <img src="images/indicator.gif">&nbsp;Añadiendo a Listas, Espere <?php if (count($this->dataItemIDArray) > 20): ?>(This could take awhile)<?php endif; ?>...
            </div>
            <div style="display:none; font: normal normal normal 12px/130% Arial, Tahoma, sans-serif;" id="addingToListAjaxingComplete">
                <img src="images/indicator.gif">&nbsp;Los elementos se han agregado a las listas con éxito.
            </div>

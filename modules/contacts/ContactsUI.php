...
class ContactsUI extends UserInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Contactos';
        $this->_subTabs = array(
            'Agregar Contacto'     => CATSUtility::getIndexName() . '?m=contacts&amp;a=add*al=' . ACCESS_LEVEL_EDIT . '@contacts.add',
            'Buscar Contactos' => CATSUtility::getIndexName() . '?m=contacts&amp;a=search',
            'Lista de Llamadas en Frío'  => CATSUtility::getIndexName() . '?m=contacts&amp;a=showColdCallList'
        );
    }

        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Contactos: Editar Contacto</h2></td>
                </tr>
            </table>
            ...
            <form name="editContactForm" id="editContactForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editContactForm);" autocomplete="off">
                    ...
                    <tr>
                        <td width="50%" height="100%" valign="top">
                            ...
                            <table class="editTable" width="100%" height="285">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="companyIDLabel" for="companyID"><span id="companyAssociatedLabel" <?php if ($this->data['leftCompany'] != 1): ?> style="display:none;" <?php endif; ?> >Previous </span>Empresa:</label>
                                    </td>
                                ...
                                <tr>
                                    <td class="tdVertical">Dado de Baja de la Empresa:</td>
                                    <td class="tdData">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <div style="display:none;" id="divOwnershipChange">
                                <input type="checkbox" name="ownershipChange" id="checkboxOwnershipChange" <?php if (!$this->canEmail): ?>disabled<?php endif; ?>> Enviar un correo electrónico al nuevo propietario informando el cambio
                            </div>
                        </td>
                    </tr>
                ...
                <input type="button" class="button" name="back"   id="back"   value="Volver a Detalles" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=show&amp;contactID=<?php echo($this->contactID); ?>');" />
            </form>

        ...
        <div id="contents"<?php echo !$this->totalContacts ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyContacts">Solo Mis Contactos</label>&nbsp;
                                    </td>
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyHotContacts">Solo Contactos Aspirantes</label>&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </form>
            ...
            <p class="note">
                <span style="float:left;">
                    Contactos - Página <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
                    (<?php echo($this->dataGrid->getNumberOfRows()); ?> Elementos)
                    <?php if ($this->dataGrid->getFilterValue('OwnerID') ==  $this->userID): ?>(Solo Mis Contactos)<?php endif; ?>
                    <?php if ($this->dataGrid->getFilterValue('IsHot') == '1'): ?>(Solo Contactos Aspirantes)<?php endif; ?>
                </span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    <div style="text-align: center; width: 600px; line-height: 22px; font-size: 18px; font-weight: bold; color: #666666; padding-bottom: 20px;">
                        Agregue contactos para realizar un seguimiento de las personas con las que trabaja.
                    </div>

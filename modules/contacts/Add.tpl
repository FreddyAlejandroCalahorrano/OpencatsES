        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Contactos: Agregar Contacto</h2></td>
                </tr>
            </table>
            ...
            <form name="addContactForm" id="addContactForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=add&amp;v=<?php if ($this->selectedCompanyID === false) { echo('-1'); } else { echo($this->selectedCompanyID); } ?>" method="post" onsubmit="return checkAddForm(document.addContactForm);" autocomplete="off">
                ...
                <table>
                    <tr>
                        <td width="50%" height="100%" valign="top">
                            ...
                            <table class="editTable" width="100%" height="285">
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        ...
                                        <?php if ($this->defaultCompanyID !== false && $this->selectedCompanyID === false): ?>
                                            <input type="checkbox" id="defaultCompany" onchange="if (this.checked){ document.getElementById('companyName').disabled = true; document.getElementById('companyID').value = '<?php echo($this->defaultCompanyID); ?>'; document.getElementById('companyName').value = &quot;<?php $this->_($this->defaultCompanyRS['name']); ?>&quot;; } else { document.getElementById('companyName').disabled = false; }">&nbsp;Contacto Interno
                                        <?php endif; ?>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td class="tdVertical">
                                        <label id="departmentLabel" for="department">Reporta a:</label>
                                    </td>
                                    <td class="tdData">
                        ...
                        <td width="50%" height="100%" valign="top">
                            <p class="noteUnsized">Información del Contacto</p>
                            ...
                            <table class="editTable" width="100%" height="285">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="phoneOtherLabel" for="phoneOther">Otro Teléfono:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="stateLabel" for="state">Privincia:</label>
                                    </td>
                                    <td class="tdData">
                ...
                <input type="submit" class="button" value="Agregar Contacto" />&nbsp;
                <input type="reset"  class="button" value="Borrar" />&nbsp;
                <input type="button" class="button" value="Volver a Contactos" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=listRecent');" />
            </form>

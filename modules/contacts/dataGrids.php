...
class ContactsListByViewDataGrid extends ContactsDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        $this->_defaultColumns = array( 
            ...
            array('name' => 'Nombre', 'width' => 80),
            array('name' => 'Apellido', 'width' => 80),
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItemPopup('Agregar a Lista', CATSUtility::getIndexName().'?m=lists&amp;a=addToListFromDatagridModal&amp;dataItemType='.DATA_ITEM_CONTACT, 450, 350);
...
class contactSavedListByViewDataGrid extends ContactsDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItem('Eliminar de esta Lista', CATSUtility::getIndexName().'?m=lists&amp;a=removeFromListDatagrid&amp;dataItemType='.DATA_ITEM_CONTACT.'&amp;savedListID='.$this->getMiscArgument(), false);
        $html .= $this->getInnerActionAreaItem('Exportar', CATSUtility::getIndexName().'?m=export&amp;a=exportByDataGrid');

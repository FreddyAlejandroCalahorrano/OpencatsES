...
function updateCalendarViewMonth()
{
    ...
    document.getElementById('calendarTitle').innerHTML = 'Calendario: '
    ...
    if (monthData.days.length == 0)
    {
        string = monthNameWrap(currentMonth) + ' ' + currentYear + ' (Sin Eventos)';
...
function updateCalendarViewWeek()
{
    ...
    weekNames = Array('1ra', '2da', '3ra', '4ta', '5ta', '6ta');

    document.getElementById('calendarTitle').innerHTML = 'Calendario: '
        + weekNames[currentWeek-1] + ' semana de ' + monthNameWrap(currentMonth)
        + ' ' + currentYear;
    ...
    document.getElementById('weekNotice').innerHTML = totalEntries + ' entradas para la ' + weekNames[currentWeek - 1] + ' \n' + 'semana de ' + monthNameWrap(currentMonth) + ' ' + currentYear;
}
...
function updateCalendarViewDay()
{
    ...
    document.getElementById('calendarTitle').innerHTML = 'Calendario: ' + monthNameWrap(currentMonth) + ' ' + currentDay + ', ' + currentYear;
    ...
    {
        /* Populate more data */
        document.getElementById('dayNotice').innerHTML = 'Cargando ' + monthNameWrap(getMonthByDay(currentYear, currentMonth, theDay)) + ' ' + getYearByDay(currentYear, currentMonth, theDay) + '...'
    ...
    document.getElementById('dayNotice').innerHTML = totalEntries + ' entradas para ' + monthNameWrap(currentMonth) + ' ' + currentDay + ', ' + currentYear;

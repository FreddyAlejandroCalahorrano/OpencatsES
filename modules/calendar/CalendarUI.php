...
class CalendarUI extends UserInterface
{
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Calendario*al=' . ACCESS_LEVEL_READ . '@calendar';
        $this->_subTabs = array(
            'Mis próximos eventos' => 'javascript:void(0);*js=calendarUpcomingEvents();*al=' . ACCESS_LEVEL_READ . '@calendar',
            'Añadir Evento' => 'javascript:void(0);*js=userCalendarAddEvent();*al=' . ACCESS_LEVEL_EDIT . '@calendar',
            'Ir a Hoy' => 'javascript:void(0);*js=goToToday();*al=' . ACCESS_LEVEL_READ . '@calendar'
        );
    }

	...
	&nbsp;</p>
        ...
        <div id="contents">
            <div id="login">
                ...
                <div id="formBlock">
                    <img src="images\bp\BP-sig.gif" alt="Login" hspace="10" vspace="10" />
                    <br />
                    <form name="loginForm" id="loginForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=login&amp;a=attemptLogin<?php if ($this->reloginVars != ''): ?>&amp;reloginVars=<?php echo($this->reloginVars); ?><?php endif; ?>" method="post" onsubmit="return checkLoginForm(document.loginForm);" autocomplete="off">
                        <div id="subFormBlock">
                            ...
                            <?php if ($this->siteNameFull != 'error'): ?>
                                ...
                                <label id="passwordLabel" for="password">Contraseña</label><br />
...
<p>
	...
	<span style="font-size: 12px;"><a href="http://forums.opencats.org ">opencats foro de soporte</a></span>
	  ...
	  <div id="footerBlock">
                ...
                Basado en trabajo original y desarrollado por <a href="http://www.opencats.org" target="_blank">OpenCATS</a>.</div>
            </div>
        </div>

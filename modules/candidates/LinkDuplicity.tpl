...
<?php TemplateUtility::printModalHeader('Candidates', array(), 'Select duplicate to this Candidate'); ?>
    ...
    <?php if (!$this->isFinishedMode): ?>
        <p>Busque un candidato a continuación y luego haga clic en el nombre del candidato para vincular
            este candidato como un duplicado para ellos.</p>
        ...
        <table class="searchTable">
            <form id="searchByCandidateNameForm" name="searchByJobTitleForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=linkDuplicate" method="post">
                ...
                <tr>
                    <td>Búsqueda por Nombre del Candidato&nbsp;</td>
                    <td><input type="text" class="inputbox" id="wildCardString_candidateName" name="wildCardString"style="width:200px;" />&nbsp;*</td>
                </tr>
                <tr>
                    <td><input type="submit" class="button" id="searchByCandidateName" name="searchByCandidateName" value="Búsqueda por Nombre del Candidato" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
            ...
            <?php if (!empty($this->rs)): ?>
                <table class="sortable" width="100%">
                    <tr>
                        ...
                        <th align="left">Teléfono Celular</th>
        ...
        <?php else: ?>
            <br />
            <p class="noteUnsized">Todos los Candidatos</p>
        ...
        <?php endif; ?>
    <?php else: ?>
        <p>Este candidato se ha agregado correctamente como duplicado del candidato seleccionado.</p>

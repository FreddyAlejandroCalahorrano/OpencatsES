        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Candidatos: Detalles del candidato
                        <?php if($_SESSION['CATS']->getAccessLevel('candidates.duplicates') >= ACCESS_LEVEL_SA): ?>    
                            <?php if(!empty($this->data['isDuplicate'])): ?>
                                ...
                                <?php foreach($this->data['isDuplicate'] as $item): ?>
                                    <?php echo '<a href='.CATSUtility::getIndexName().'?m=candidates&amp;a=show&amp;candidateID='.$item['duplicateTo'].' target=_blank>Duplicado</a>' ?>
            ...
            <p class="note">Detalles del candidato</p>

            <?php if ($this->data['isAdminHidden'] == 1): ?>
                <p class="warning">Candidato oculto. Solo administradores de CATS pueden verlo o buscarlo. Para hacerlo visible a los usuarios del sitio, haga clic <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=administrativeHideShow&amp;candidateID=<?php echo($this->candidateID); ?>&amp;state=0" style="font-weight:bold;">Aquí.</a></p>
            <?php endif; ?>
                ...
                <tr style="vertical-align:top;">
                    ...
                    <?php endif; ?>
                        <table class="detailsInside" height="100%">
                            ...
                            <tr>
                                <td class="vertical">2do C Electrónico:</td>
                                <td class="data">
                            ...
                            <tr>
                                <td class="vertical">Teléfono de Casa:</td>
                                <td class="data"><?php $this->_($this->data['phoneHome']); ?></td>
                            </tr>

                            <tr>
                                <td class="vertical">Teléfono Celular:</td>
                            ...
                            <tr>
                                <td class="vertical">Hora para llamar:</td>
                ...
                <tr>
                    <td>
                        <table class="detailsInside">
                            ...
                            <tr>
                                <td valign="top" class="vertical">Próximos Eventos:</td>
                                <td id="shortNotes" style="display:block;" class="data">
                                ...
                                <td valign="top" class="data">
                                    ...
                                    <?php if (!$this->isPopup): ?>
                                        <?php if ($this->getUserAccessLevel('candidates.createAttachment') >= ACCESS_LEVEL_EDIT): ?>
                                            ...
                                            <?php endif; ?>
                                                <img src="images/paperclip_add.gif" width="16" height="16" border="0" alt="Add Attachment" class="absmiddle" />&nbsp;Agregar Archivos Adjuntos
                                            </a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </td>
                            ...
                            <tr>
                                <td valign="top" class="vertical">Etiquetas:
                                    <?php if (!$this->isPopup){ ?>
            ...
            <?php if ($this->getUserAccessLevel('candidates.delete') >= ACCESS_LEVEL_DELETE): ?>
                <a id="delete_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=delete&amp;candidateID=<?php echo($this->candidateID); ?>" onclick="javascript:return confirm('Eliminar este candidato?');">
            ...
            <?php if ($this->getUserAccessLevel('candidates.administrativeHideShow') >= ACCESS_LEVEL_MULTI_SA): ?>
                <?php if ($this->data['isAdminHidden'] == 1): ?>
                    ...
                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=administrativeHideShow&amp;candidateID=<?php echo($this->candidateID); ?>&amp;state=1">
                        <img src="images/resume_preview_inline.gif" width="16" height="16" class="absmiddle" alt="delete" border="0" />&nbsp;Ocultar Vista como Admininstrador
                    </a>
                <?php endif; ?>
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            <?php if ($this->getUserAccessLevel('candidates.duplicates') >= ACCESS_LEVEL_SA): ?>
                <a href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=linkDuplicate&amp;candidateID=<?php echo($this->candidateID); ?>', 750, 390, null); return false;">
                    <img src="images/actions/duplicates.png" width="16" height="16" class="absmiddle" alt="add duplicate" border="0" />&nbsp;Enlace duplicado
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
<?php endif; ?>
            ...
            <p class="note">Órdenes de trabajo para los candidatos</p>
            <table class="sortablepair">
                <tr>
                    <th></th>
                    <th align="left">Coincidencia</th>
                    <th align="left">Num. Referencia</th>
                    <th align="left">Titulo</th>
                    <th align="left">Empresa</th>
                    <th align="left">Dueño</th>
                    <th align="left">Agregado</th>
                    <th align="left">Reclutado por</th>
...
<?php if (!$this->isPopup): ?>
                        <td align="center" nowrap="nowrap">
                            ...
                            <?php if ($this->getUserAccessLevel('pipelines.removeFromPipeline') >= ACCESS_LEVEL_DELETE): ?>
                                <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=removeFromPipeline&amp;candidateID=<?php echo($this->candidateID); ?>&amp;jobOrderID=<?php echo($pipelinesData['jobOrderID']); ?>"  onclick="javascript:return confirm('Eliminar del Pipeline <?php $this->_(str_replace('\'', '\\\'', $pipelinesData['title'])); ?> (<?php $this->_(str_replace('\'', '\\\'', $pipelinesData['companyName'])); ?>)?')">
                                ...
                                <tr>
                                    <td align="left" style="padding: 6px 6px 6px 6px; background-color: white; clear: both;">
                                        <div style="overflow: auto; height: 200px;" id="pipelineInner<?php echo($rowNumber); ?>">
                                            <img src="images/indicator.gif" alt="" />&nbsp;&nbsp;Cargando Detalles de la Canalización...
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<?php endif; ?>
            ...
            <table id="activityTable" class="sortable">
                <tr>
                    ...
                    <th align="left" width="90">Ingresó</th>
                    <th align="left" width="250">Referente</th>
                    <th align="left">Notas</th>
<?php if (!$this->isPopup): ?>
                    <th align="left" width="40">Acción</th>
<?php endif; ?>
                </tr>
                        ...
                        <td align="center" >
                            <?php if ($this->getUserAccessLevel('candidates.edit') >= ACCESS_LEVEL_EDIT): ?>
                                <a href="#" id="editActivity<?php echo($activityData['activityID']); ?>" onclick="Activity_editEntry(<?php echo($activityData['activityID']); ?>, <?php echo($this->candidateID); ?>, <?php echo(DATA_ITEM_CANDIDATE); ?>, '<?php echo($this->sessionCookie); ?>'); return false;">
                                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="" border="0" title="Editar" />
                                </a>
                            <?php endif; ?>
                            <?php if ($this->getUserAccessLevel('candidates.delete') >= ACCESS_LEVEL_DELETE): ?>
                                <a href="#" id="deleteActivity<?php echo($activityData['activityID']); ?>" onclick="Activity_deleteEntry(<?php echo($activityData['activityID']); ?>, '<?php echo($this->sessionCookie); ?>'); return false;">
                                    <img src="images/actions/delete.gif" width="16" height="16" class="absmiddle" alt="" border="0" title="Borrar" />
                                </a>
                            <?php endif; ?>
                        </td>
<?php endif; ?>

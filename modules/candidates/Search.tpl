        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Candidatos: Buscar candidatos</h2></td>
                </tr>
            </table>

            <p class="note">Buscar candidatos</p>
                ...
                <tr>
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            ...
                            <label id="searchModeLabel" for="searchMode">Búsqueda por:</label>&nbsp;
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByFullName"<?php if ($this->mode == "searchByFullName"): ?> selected<?php endif; ?>>Nombre del candidato</option>
                                <option value="searchByResume"<?php if ($this->mode == "searchByResume" || empty($this->mode)): ?> selected<?php endif; ?>>Palabras Clave</option>
                                <option value="searchByKeySkills"<?php if ($this->mode == "searchByKeySkills"): ?> selected<?php endif; ?>>Habilidades</option>
                                <option value="searchByCity"<?php if ($this->mode == "searchByCity"): ?> selected<?php endif; ?>>Ciudad</option>
                                <option value="phoneNumber"<?php if ($this->mode == "phoneNumber"): ?> selected<?php endif; ?>>Número Celular</option>
                            </select>&nbsp;
                            ...
                            <input type="submit" class="button" id="searchCandidates" name="searchCandidates" value="Buscar" />

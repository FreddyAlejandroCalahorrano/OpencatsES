        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Candidatos: Resultados del Cuestionario</h2></td>
               </tr>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr>
                    <td align="left" valign="top">
                        <input type="button" class="button" value="<- Volver al Perfil del Candidato" onclick="document.location.href='<?php echo CATSUtility::getIndexName(); ?>?m=candidates&a=show&candidateID=<?php echo $this->candidateID; ?>';" />
                    </td>
                    <td align="right">
...
<?php endif; ?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr>
                    <td width="40%" align="left" valign="top">
                        ...
                        <b>Información del Candidato:</b><br />
            ...
            <br /><br />
            <span style="font-size: 14px;">
            <b><?php echo $this->cData['firstName'] . ' ' . $this->cData['lastName']; ?>'s Resumen:</b>
            <br />
            <div>

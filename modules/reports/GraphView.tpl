...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body style="background: #fff;">
        <div class="outer">
            ...
            <p align="center">El gráfico se actualiza cada 5 minutos. Presione F11 para alternar el modo de pantalla completa en la mayoría de los navegadores.</p>

            <p align="center"><img src="<?php $this->_($this->theImage); ?>" alt="Graph" /></p>

            <p align="center"><a href="#" onclick="window.close('fs'); return false;">Cerrar Ventana</a></p>

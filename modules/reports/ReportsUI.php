...
class ReportsUI extends UserInterface
{
    public function __construct()
    {
        ...
        $this->_moduleTabText = 'Informes';
        $this->_subTabs = array(
                'Informes EEO' => CATSUtility::getIndexName() . '?m=reports&amp;a=customizeEEOReport'
            );
    }
    ...
    private function showSubmissionReport()
    {
        ...
        switch ($period)
        {
            case 'yesterday':
                ...
                $reportTitle = 'Informe de el Día de Ayer';
                break;

            case 'thisWeek':
                $period = TIME_PERIOD_THISWEEK;
                $reportTitle = 'Informe de Esta Semana';
                break;

            case 'lastWeek':
                $period = TIME_PERIOD_LASTWEEK;
                $reportTitle = 'Informe de la Semana Pasada';
                break;

            case 'thisMonth':
                $period = TIME_PERIOD_THISMONTH;
                $reportTitle = 'Informe de Este Mes';
                break;

            case 'lastMonth':
                $period = TIME_PERIOD_LASTMONTH;
                $reportTitle = 'Informe del Mes Pasado';
                break;

            case 'thisYear':
                $period = TIME_PERIOD_THISYEAR;
                $reportTitle = 'Informe de Este Año';
                break;

            case 'lastYear':
                $period = TIME_PERIOD_LASTYEAR;
                $reportTitle = 'Informe del Año Pasado';
                break;

            case 'toDate':
                $period = TIME_PERIOD_TODATE;
                $reportTitle = 'Informe Hasta la Fecha';
                break;

            case 'today':
            default:
                $period = TIME_PERIOD_TODAY;
                $reportTitle = 'Informe de Hoy';
                break;
        }

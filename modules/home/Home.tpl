            ...
            <table>
                <tr>
                    <td align="left" valign="top" style="text-align: left; height:50px;">
                        <div class="noteUnsizedSpan">Mis Llamadas Recientes</div>
            ...
            <table>
                <tr>
                    <td align="left" valign="top" style="text-align: left; width: 50%; height: 240px;">
                        <div class="noteUnsizedSpan">Contrataciones Recientes</div>

                        <table class="sortable" style="margin: 0 0 4px 0;">
                            <tr>
                                <th align="left" style="font-size:11px;">Nombre</th>
                                <th align="left" style="font-size:11px;">Empresa</th>
                                <th align="left" style="font-size:11px;">Reclutador</th>
                                <th align="left" style="font-size:11px;">Fecha</th>
                            </tr>
            ...
            <table>
                <tr>
                    <td align="left" valign="top" style="text-align: left; width: 50%; height: 260px;">
                        <div class="noteUnsizedSpan">Candidatos importantes (Presentado, Entrevistado, Ofrecido en Órdenes de Trabajo Activas) - Página <?php echo($this->dataGrid->getCurrentPageHTML()); ?> (<?php echo($this->dataGrid->getNumberOfRows()); ?> Elementos)</div>

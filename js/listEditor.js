    ...
    var html =
        '<table>' +
            '<tr>' +
                ...
                '</td>' +
                '<td>' +
                    '<input id="listEditorButtonAdd" type="button" value="Añadir" style="width: 80px;" class="button" onclick="listEditorAddValue();" />' +
                    '<input id="listEditorButtonSave" type="button" value="Guardar" style="width: 80px; display: none;" class="button" onclick="listEditorSaveValue();" />' +
                '</td>' +
            '</tr>' +
            '<tr>' +
                '<td>' +
                ...
                '</td>' +
                '<td>' +
                    '<input id="listEditorButtonDoModify" type="button" value="Modicar" style="width: 80px;" class="button" onclick="listEditorDoModify();" />' +
                    '<input id="listEditorButtonDoAdd" type="button" value="Añadir" style="width: 80px; display: none;" class="button" onclick="listEditorDoAdd();" /><br /><br />' +
                    '<input id="listEditorButtonDelete" type="button" value="Borrar" style="width: 80px;" class="button" onclick="listEditorDeleteValue();" /><br /><br />' +
                    '<input id="closeButton" type="button" value="Cerrar" style="width: 80px;" class="button" onclick="closeWindow()" />' +
                '</td>' +
            '</tr>' +
        '</table>';
            ...
            '<tr>' +
                ...
                '<td>' +
                  '<span id="listEditorButtonAdd">'+
                    '<input id="listEditorButtonAdd" type="button" value="Agregar como Cuadro de Texto" style="width: 110px;" class="button" onclick="listEditorAddValue();" /><br />' +
                    '<input id="listEditorButtonAdd" type="button" value="Agregar como Casilla de Verificación" style="width: 110px;" class="button" onclick="listEditorAddValueCB();" /></span>' +
                    '<input id="listEditorButtonSave" type="button" value="Guardar" style="width: 80px; display: none;" class="button" onclick="listEditorSaveValue();" />' +
                '</td>' +
            '</tr>' +
            '<tr>' +
                ...
                '</td>' +
                '<td>' +
                    '<input id="listEditorButtonDoModify" type="button" value="Modificar" style="width: 80px;" class="button" onclick="listEditorDoModify();" />' +
                    '<input id="listEditorButtonDoAdd" type="button" value="Añadir" style="width: 80px; display: none;" class="button" onclick="listEditorDoAdd();" /><br /><br />' +
                    '<input id="listEditorButtonDelete" type="button" value="Borrar" style="width: 80px;" class="button" onclick="listEditorDeleteValue();" /><br /><br />' +
                    '<input id="closeButton" type="button" value="Cerrar" style="width: 80px;" class="button" onclick="closeWindow()" />' +
                '</td>' +

...
var MonthNames = new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembrer','Octubre','Noviembre','Diciembre');
...
function DateInput(DateName, Required, DateFormat, DefaultDate, TabIndex)
{
    ...
    with (document)
    {
        ...
        if (!Required)
        {
            if (DefaultDate == '')
            {
                writeln('<option selected="selected" value="">Ninguno</option>');
            }
            else
            {
                writeln('<option value="">Ninguno</option>');
            }
        }
...
function DateInputForDOM(DateName, Required, DateFormat, DefaultDate, TabIndex)
{
    ...
    if (!Required)
    {
        if (DefaultDate == '')
        {
            outCode += ('<option selected="selected" value="">Ninguno</option>');
        }
        else
        {
            outCode += ('<option value="">Ninguno</option>');
        }
    }

...
class ExportUtility
{
    ...
    public static function getForm($dataItemType, $IDs, $popUpOffset = 35, $linkOffset = 5)
    {
        ...
        $menu =
            ...
            . '<input type="checkbox" name="allBox" title="Selecionar Todo" onclick="toggleChecksAll();" />'
            . '</form>'
            . '</div>'
            . '<a href="#" id="exportBoxLink" onclick="showBox(\'ExportBox\'); return false;">Exportar</a><br />'
            . '<div class="exportPopup" id="ExportBox" align="left" onmouseover="showBox(\'ExportBox\');" onmouseout="hideBox(\'ExportBox\');">'
            . '<a href="' . $allRecordsURL . '">Exportar Todos los Registros</a><br />'
            . '<a href="' . $currentPageURL . '">Exportar Página Actual</a><br />'
            . '<a href="#" onclick="checkSelected(); return false;">Exportar los Registros Seleccionados</a>'
            . '</div>';

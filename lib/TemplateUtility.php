...
class TemplateUtility
{
    ...
    public static function printQuickSearch($wildCardString = '')
    {
        ...
        if (!empty($MRU))
        {
            echo '<span class="MRUTitle">Reciente:&nbsp;</span>&nbsp;', $MRU, "\n";
        }
        else
        {
        ...
        else
        {
            ...
            echo '<span class="quickSearchLabel" id="quickSearchLabel">Búsqueda Rápida:</span>&nbsp;', "\n";
        }

        echo '<input name="quickSearchFor" id="quickSearchFor" class="quickSearchBox" value="',
             $wildCardString, '" />&nbsp;', "\n";
        echo '<input type="submit" name="quickSearch" class="button" value="Ir" />&nbsp;', "\n";
        echo '</div>', "\n";
        echo '</form>', "\n";
        echo '</div>', "\n";
    }
    ...
    {
        echo '<input type="button" class="button" name="advancedSearch" id="advancedSearch" value="Busqueda Avanzada"',
    ...
    public static function printSavedSearch($savedSearchRS)
    {
        ...
        echo 'Búsquedas recientes&nbsp;&nbsp;';
        echo '<img title="Para guardar una búsqueda reciente, presione el botón + a continuación."',
        ...
        echo 'Búsquedas Guardadas&nbsp;&nbsp;';
        echo '<img title="Para eliminar una búsqueda reciente, presione el botón -."',
             ' src="images/information.gif" alt="" width="16" height="16" />';

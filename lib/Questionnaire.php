...
class Questionnaire
{
    ...
    public function convertQuestionConstantToType($type)
    {
        switch ($type)
        {
            case QUESTIONNAIRE_QUESTION_TYPE_CHECKBOX: return 'Casillas';
            case QUESTIONNAIRE_QUESTION_TYPE_SELECT: return 'Lista Desplegable';
            case QUESTIONNAIRE_QUESTION_TYPE_RADIO: return 'Botones de Opción';

...
class ContactsDataGrid extends DataGrid
{
    ...
    public function __construct($instanceName, $siteID, $parameters, $misc = 0)
    {
        ...
        $this->_classColumns = array(
            ...
            'Departamento' =>  array('select'  => 'company_department.company_department_id AS companyDepartmentID, company_department.name as department',
            ...
            'Teléfono Celular' =>    array('select'  => 'contact.phone_cell AS cellPhone',
            ...
            'Otro Teléfono' =>   array('select'  => 'contact.phone_other AS otherPhone',
            ...
            'Correo Electrónico' =>         array('select'   => 'contact.email1 AS email1',
                                     'sortableColumn'     => 'email1',
                                     'pagerWidth'    => 80,
                                     'filter'         => 'contact.email1'),

            '2do C-Electrónico' =>     array('select'   => 'contact.email2 AS email2',
                                     'sortableColumn'     => 'email2',
                                     'pagerWidth'    => 80,
                                     'filter'         => 'contact.email2'),

            'Dirección' =>        array('select'   => 'contact.address AS address',
                                     'sortableColumn'     => 'address',
                                     'pagerWidth'    => 250,
                                     'alphaNavigation' => true,
                                     'filter'         => 'contact.address'),

            'Ciudad' =>           array('select'   => 'contact.city AS city',
                                     'sortableColumn'     => 'city',
                                     'pagerWidth'    => 80,
                                     'alphaNavigation' => true,
                                     'filter'         => 'contact.city'),
            ...
            'Provincia' =>          array('select'   => 'contact.state AS state',
            ...
            'Código Postal' =>            array('select'  => 'contact.zip AS zip',
                                     'sortableColumn'    => 'zip',
                                     'pagerWidth'   => 50,
                                     'filter'         => 'contact.zip'),

            'Notas' =>     array('select'  => 'contact.notes AS notes',
                                     'sortableColumn'    => 'notes',
                                     'pagerWidth'   => 300,
                                     'filter'         => 'contact.notes'),

            'Dueño' =>         array('pagerRender'      => 'return StringUtility::makeInitialName($rsData[\'ownerFirstName\'], $rsData[\'ownerLastName\'], false, LAST_NAME_MAXLEN);',

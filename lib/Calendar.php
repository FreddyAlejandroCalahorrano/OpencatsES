    ...
    public function getUpcomingEventsHTML($limit, $flag = UPCOMING_FOR_CALENDAR)
    {
        switch ($flag)
        {
            case UPCOMING_FOR_CALENDAR:
                $HTML = '<div class="noteUnsizedSpan">Mis Próximos Eventos / Llamadas</div>';
                $style = '';
                $criteria = '';
                break;

            case UPCOMING_FOR_DASHBOARD:
                $HTML = '<div class="noteUnsizedSpan" style="width:100%;">Mis Próximos Eventos</div>';
                $style = 'font-size:11px;';
                $criteria = 'AND NOT TYPE = 100';
                break;

            case UPCOMING_FOR_DASHBOARD_FUP:
                $HTML = '<div class="noteUnsizedSpan">Mis Próximas Llamadas</div>';
                $style = 'font-size:11px;';
